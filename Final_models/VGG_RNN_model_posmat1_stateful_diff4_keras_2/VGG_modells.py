...
def VGG_A(keep_prob, batch_size):
    ...
    model.add(keras.layers.convolutional.Conv2D(num_filters1, (filter_size1, filter_size1), strides=(1,1), activation='relu', padding='same'))
    ...
    model.add(keras.layers.recurrent.LSTM(256, batch_input_shape=(batch_size, 8192), return_sequences=False, dropout=keep_prob))
